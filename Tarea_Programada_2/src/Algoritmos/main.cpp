...
int main()
{
    ...
    */
    ...
    Vertice a = Algoritmos::buscarVertice(grafo, 'a'); 
    Vertice b = Algoritmos::buscarVertice(grafo, 'b');
    Vertice c = Algoritmos::buscarVertice(grafo, 'c');
    Vertice d = Algoritmos::buscarVertice(grafo, 'd');
    Vertice e = Algoritmos::buscarVertice(grafo, 'e');
    Vertice f = Algoritmos::buscarVertice(grafo, 'f');
    ...
    */
    ...
    std::vector<Vertice> solucionHamiltonBera = Algoritmos::HamiltonBERA(grafo);
    ...
    */
    ...
    ListaDijkstra listaDijkstra = Algoritmos::Dijkstra(grafo, f);
    ...
    Algoritmos::imprimirGrafo(grafo);
    Algoritmos::imprimirGrafo(grafoMinimo);

    std::cout<<"\n"<<std::endl;
    char listaA[] = {'a','a','a','a','a','b','b', 'b','c', 'c', 'e', 'f'}; 
    char listaB[] = {'b','c','d','e','f','c','d','f','e', 'f', 'f', 'd'};
    int listaP[] = {2, 8, 6, 7, 3, 3, 9, 5, 1, 6, 4, 9};
    Vertice x = Algoritmos::buscarVertice(grafo, listaA[0]);
    Vertice y = Algoritmos::buscarVertice(grafo, listaB[0]);
    ...
    for (int i = 1; i < 12; i++)
    {
        x = Algoritmos::buscarVertice(grafo, listaA[i]);
        y = Algoritmos::buscarVertice(grafo, listaB[i]);
...
*/
    ...
    // Algoritmos::Dijkstra(grafo, inicio, listaCaminosMasCortos);
    // std::cout<<"*****************DDD***********"<< std::endl;
    // Algoritmos::imprimirListaDijkstra(listaCaminosMasCortos);
