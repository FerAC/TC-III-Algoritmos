 ...
 */
Nodo Controlador::averiguarHermanoIzquierdo(Nodo nodo, Arbol &arbol)
{
 ...
 */
size_t Controlador::nivelesArbolRPO(Arbol &arbol, Nodo subraiz)
{
    const Nodo &NodoNulo = Nodo();
 ...
 */
size_t Controlador::nivelesArbolRPN(Arbol &arbol)
{
    const Nodo &NodoNulo = Nodo();
 ...
 */
int Controlador::averiguarProfundidadNodo(Arbol &arbol, Nodo nodo)
{
 ...
 * @remark El arbol debe estar inicializado.
 */
void Controlador::imprimirArbol(Arbol &arbol)
{
    const Nodo &NodoNulo = Nodo();
 ...
 * @remark El arbol debe estar inicializado.
 */
void Controlador::listarPorNiveles(Arbol &arbol)
{
    const Nodo &NodoNulo = Nodo();
 ...
 */
Nodo Controlador::buscarEtiqueta(int etiqueta, Arbol &arbol)
{
    const Nodo &NodoNulo = Nodo();
 ...
 */
void Controlador::listarPorPreorden(Arbol &arbol, Nodo nodo)
{
 ...
 */
void Controlador::padre(int elemento, Arbol &arbol)
{
 ...
 */
void Controlador::hermanoDerecho(int etiqueta, Arbol &arbol)
{
 ...
 * @remark Tanto la etiqueta como el arbol deben estar incializados. Debe existir al menos un nodo con esa etiqueta en el arbol.
 */
void Controlador::hijoMasIzquierdo(int etiqueta, Arbol &arbol)
{
    Nodo nodoPadre = buscarEtiqueta(etiqueta, arbol);
 ...
 */
void Controlador::borrarHoja(int valorBorrado, Arbol &arbol)
{
 ...
 */
void Controlador::agregarHijo(int etiqueta, int etiquetaHijo, Arbol &arbol)
{
    Nodo nodoPadre = buscarEtiqueta(etiqueta, arbol);
 ...
 * @remark Ambas etiquetas y el arbol deben estar inicializados. La etiqueta identificadora del nodo padre debe existir en un nodo del arbol.
 */
void Controlador::modificaEtiqueta(int etiquetaVieja, int nuevaEtiqueta, Arbol &arbol)
{
 ...
 */
void Controlador::imprimirNodosEnNivel(Arbol &arbol, Nodo subraiz, int nivel)
{
 ...
 */
void Controlador::borrarSubArbol(Arbol &arbol, Nodo subraiz)
{
 ...
 */
void Controlador::crearArbol(size_t i, size_t k, ListaIndexada &lista, Arbol &arbol)
{
 ...
 */
void Controlador::crearArbolAlturaExtrema(size_t cantidadNodos, Arbol &arbol)
{
    // Colocamos raiz
    arbol.PonerRaiz(0);
 ...
 */
void Controlador::crearArbolAnchuraExtrema(size_t anchura, Arbol &arbol)
{
...
void Controlador::crearArbolHijoCortoHijoLargo(size_t cantidadNodos, size_t cantidadHijosRaiz, Arbol &arbol)
{
...
void Controlador::crearArbolHijoCortoHijoLargoPeorCaso(size_t cantidadNodos, size_t cantidadHijosRaiz, Arbol &arbol)
{
    ...
    while (hermano != nodoNulo)
    {
        ...
        else if (esLargo == 1)
        {
            ...
            if (arbol.HermanoDerecho(hermano) == nodoNulo || arbol.HermanoDerecho(arbol.HermanoDerecho(hermano)) == nodoNulo)
            {
                ...
                arbol.AgregarHijo(0, hijo); // ultima hoja repetida
            }
            else
            {
                while (contadorLocal < largoHijos)
