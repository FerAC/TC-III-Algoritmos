...
public:
    ...
    static void crearArbolHijoCortoHijoLargoPeorCaso(size_t cantidadNodos, size_t cantidadHijosRaiz, Arbol &arbol);
    // {
    ...
    static void crearArbolHijoCortoHijoLargoMejorCaso(size_t cantidadNodos, size_t cantidadHijosRaiz, Arbol &arbol);
    // {
